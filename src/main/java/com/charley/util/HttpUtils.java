...
public class HttpUtils {
    ...
    public static void main(String[] args) {
        ...
        /*String pathUrl = "http://localhost:8105/bus/refresh?destination=customers:config_client";*/
        String pathUrl = "http://localhost:8095/bus/refresh";
